...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        if (!Usuario.count()) {
            ...
            new Usuario(rut: "64353123-k", nombres: "usertestuno", paterno: "uno", materno: "-", direccion: "-", correo: "usuarioadminuno@grails.org", telefono: "-", clave: "qwerty", tipo: 1, creadoPor:"admin").save(failOnError: true)
            new Usuario(rut: "87524533-k", nombres: "usertestdos", paterno: "dos", materno: "-", direccion: "-", correo: "usuarioadmindos@grails.org", telefono: "-", clave: "qwerty", tipo: 1, creadoPor:"admin").save(failOnError: true)
            new Usuario(rut: "34553677-1", nombres: "Homero", paterno: "Simpsons", materno: "Fox", direccion: "Avda. Siempre Viva", correo: "ingeniero1@gmail.com", telefono: "78787878", clave: "pantalla1", tipo: 2, creadoPor:"admin").save(failOnError: true)
        }
        ...
        if (!Proyecto.list()) {
            new Proyecto(codigo: "PR-01", nombre: "Samsung tecnologias etc", fechaCreacion: "2016-08-19 11:49:00.0", fechaFin: "2016-08-19 11:49:00.0", estado: "ACTIVADO", tipo: "PUBLICO", empresa: 1, creadoPor:"admin").save(failOnError: true)
            new Proyecto(codigo: "PR-02", nombre: "Proyecto 1 Para el Ingeniero 1", fechaCreacion: "2016-08-01 00:00:00.0", fechaFin: "2016-12-31 00:00:00.0", estado: "ACTIVADO", tipo: "PUBLICO", empresa: 2, creadoPor:"admin").save(failOnError: true)
            new Proyecto(codigo: "PR-03", nombre: "Proyecto 2 Para el Ingeniero 1", fechaCreacion: "2016-08-01 00:00:00.0", fechaFin: "2016-12-31 00:00:00.0", estado: "ACTIVADO", tipo: "PRIVADO", empresa: 2, creadoPor:"admin").save(failOnError: true)
        }
        ...
        if (!Auditoria.list()) {
            new Auditoria(fecha: "2016-08-19 11:49:00.0", descripcion: "Auditoria cargada automaticamente", estado: "En espera de aporvación por el administrador", usuario: 1, proyecto: 1, creadoPor:"admin").save(failOnError: true)
        }
        ...
        if (!Asignacion.list()) {
            ...
            new Asignacion(detalle: "Asignación para Ingeniero 1, proyecto 2", fecha: "2016-08-10 00:0:00.0", usuario: 3, proyecto: 2, creadoPor:"admin").save(failOnError: true)
            new Asignacion(detalle: "Asignación para Ingeniero 1, proyecto 3", fecha: "2016-08-10 00:0:00.0", usuario: 3, proyecto: 3, creadoPor:"admin").save(failOnError: true)
        }
