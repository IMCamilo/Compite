      ...
      <div class="content">
        ...
        <div class="content-container">
          <div class="content-nav content-nav-top">
            <a class="prev-page" href="Auditorias.html">
          ...
          <div class="page-toc">
            <ul>
              <li class="numbered visible">
                <a href="#egresos"><span class="number">6.</span>Egresos</a>
                <ul>
                  <li class="numbered visible"><a href="#ver-listado-de-egresos"><span class="number">6.1.</span>Ver Listado de Egresos</a></li>
                  <li class="numbered visible"><a href="#ver-detalle-de-egresos"><span class="number">6.2.</span>Ver Detalle de Egresos</a></li>
                  <li class="numbered visible"><a href="#generar-reporte-de-egresos"><span class="number">6.3.</span>Generar Reporte de Egresos</a></li>
                </ul>
              </li>
            </ul>
          </div>
          <div class="main-content">
            <h1 id="egresos"><span class="number">6.</span>Egresos</h1>
            <h2 id="ver-listado-de-egresos"><span class="number">6.1.</span>Ver Listado de Egresos</h2>
            <pre><code class="nohighlight">Al ingresar a la vista Egreso se puede ver el inmediatamente el listado de egresos.
</code></pre>
            <h2 id="ver-detalle-de-egresos"><span class="number">6.2.</span>Ver Detalle de Egresos</h2>
            <pre><code class="nohighlight">Al ingresar a ver podemos ver el detalle del egreso seleccionado. Donde también, podemos generar un reporte, cargar algún archivo o volver al listado detalle de egresos.
</code></pre>
            <h2 id="generar-reporte-de-egresos"><span class="number">6.3.</span>Generar Reporte de Egresos</h2>
            <pre><code class="nohighlight">Al Presionar generar un reporte podemos ver el egreso, el cual también podemos imprimirlo o guardarlo en un archivo en el pc.
</code></pre>
          </div>
