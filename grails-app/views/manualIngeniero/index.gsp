<html>
  <head>
    ...
    <title>1. Manual Ingeniero - Gaiden</title>
  </head>
  <body>
    <div class="wrapper">
      <div class="header">
      ...
      <div class="content">
        ...
        <div class="content-container">
          ...
          <div class="page-toc">
            <ul>
              <li class="numbered visible"><a href="#manual-ingeniero"><span class="number">1.</span>Manual Ingeniero</a></li>
            </ul>
          </div>
          <div class="main-content">
            <h1 id="manual-ingeniero"><span class="number">1.</span>Manual Ingeniero</h1>
          </div>
