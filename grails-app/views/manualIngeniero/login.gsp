<html>
  <head>
    ...
    <title>2. Iniciar Sesión - Gaiden</title>
  </head>
  <body>
    <div class="wrapper">
      <div class="header">
      ...
      <div class="content">
        ...
        <div class="content-container">
          <div class="content-nav content-nav-top">
            ...
            <a class="next-page" href="Ingeniero.html">
          ...
          <div class="page-toc">
            <ul>
              <li class="numbered visible"><a href="#iniciar-sesin"><span class="number">2.</span>Iniciar Sesión</a></li>
            </ul>
          </div>
          <div class="main-content">
            <h1 id="iniciar-sesin"><span class="number">2.</span>Iniciar Sesión</h1>
