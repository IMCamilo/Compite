            ...
            <g:form resource="${this.proyecto}" method="PUT">
                ...
                <fieldset class="form">
                    ...
                    <div class="fieldcontain required">
                        ...
                        <input name="estado" value="${proyecto.estado}" required="" id="estado" type="text">
                    </div>
                    <div class="fieldcontain required">
                        <label for="tipo">Tipo
                            <span class="required-indicator">*</span>
                        </label>
                        <input name="tipo" value="${proyecto.tipo}" required="" id="tipo" type="text">
                    </div>
                    <div class="fieldcontain required">
                    ...
                    <div class="fieldcontain required">
                        <label for="estado">Empresa
                            <span class="required-indicator">*</span>
                        </label>
                        <input name="empresa" value="${proyecto.empresaId}" placeholder="desplegable empresa acá" required="" id="estado" type="text">
                    </div>
                    <div class="fieldcontain required">
